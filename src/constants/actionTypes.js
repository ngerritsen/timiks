...
export const SAVE_TIME_SUCCEEDED = 'SAVE_TIME_SUCCEEDED';
export const REMOVE_TIME = 'REMOVE_TIME';
export const REMOVE_TIME_SUCCEEDED = 'REMOVE_TIME_SUCCEEDED';
export const UPDATE_TIME = 'UPDATE_TIME';
export const UPDATE_TIME_SUCCEEDED = 'UPDATE_TIME_SUCCEEDED';
export const CLEAR_TIMES = 'CLEAR_TIMES';
export const CLEAR_TIMES_SUCCEEDED = 'CLEAR_TIMES_SUCCEEDED';
export const ARCHIVE_TIMES = 'ARCHIVE_TIMES';
export const ARCHIVE_TIMES_SUCCEEDED = 'ARCHIVE_TIMES_SUCCEEDED';
export const SAVE_TIMES_SUCCEEDED = 'SAVE_TIMES_SUCCEEDED';
